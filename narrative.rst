...
There are already applications available to people in repressive countries to
help them chat with one another and browse the web, such as Text Secure
(<https://whispersystems.org>) and Tor Browser
(<https://www.torproject.org/>). But chatting and web-browsing are only some
of what we need in order to take part in the free and open dialogue of the
Internet. We also need to collaborate and to share our work.
...
We will design a simple process based on sending a short “invitation” code
